      ...
      type basin_control_codes
        ...
        integer :: lapse = 0     !! precip and temperature lapse rate control
                                 ...
                                 !!   1 = adjust for elevation (basin scale - global lapse rates) Timo Modified
                                 !!   2 = adjust for elevation (HRU scale - spatially distributed lapse rates) Timo Modified
        ...
        integer :: surlag_sd = 0       !!   0 = surlag spatially distributed not active; 1 = surlag spatially distributed active Timo Modified
