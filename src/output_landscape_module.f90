      ...
      type output_waterbal
        ...
        real :: snomlt = 0.           !mm H2O        |snow melt 
        real :: glmlt = 0.            !mm H2O        |ice accumulation
        real :: glacc = 0.            !mm H2O        |ice melt
        ...
        real :: glsubl = 0.           !mm H2O        |ice sublimation
        ...
        real :: gwe = 0.              !m             |water equivalent in glacier
      ...
      type output_waterbal_header
        ...
        character (len=12) :: glmlt      =  "       glmlt"   !! SWAT+GL Timo    
        character (len=12) :: glacc      =  "       glacc"   !! SWAT+GL Timo    
        ...
        character (len=12) :: glsubl     =  "        subl" !! SWAT+GL Timo 
        ...
        character (len=12) :: gwe        =  "         gwe" !! SWAT+GL Timo   
      ...
      type output_waterbal_header_units
        ...
        character (len=12) :: glmlt      =  "          mm"     ! SWAT+GL  
        character (len=12) :: glacc      =  "          mm"     ! SWAT+GL  
        ...
        character (len=12) :: glsubl     =  "          mm"      ! SWAT+GL
        ...
        character (len=12) :: gwe        =  "           m"      ! SWAT+GL
...
!**********************new
      ...
      function hruout_waterbal_add (hru1, hru2) result (hru3)
        ...
        hru3%glmlt = hru1%glmlt + hru2%glmlt    ! SWAT+GL 
        hru3%glacc = hru1%glacc + hru2%glacc    ! SWAT+GL 
        ...
        hru3%glsubl = hru1%glsubl + hru2%glsubl         ! SWAT+GL 
        ...
        hru3%gwe = hru1%gwe + hru2%gwe ! SWAT+GL 
...
!***************************new
      ...
      function hruout_waterbal_div (hru1,const) result (hru2)
        ...
        hru2%glmlt= hru1%glmlt / const      ! SWAT+GL
        hru2%glacc= hru1%glacc / const      ! SWAT+GL
      ...
      function hruout_waterbal_ave (hru1,const) result (hru2)
        ...
        hru2%glmlt= hru1%glmlt       ! SWAT+ GL
        hru2%glacc= hru1%glacc      ! SWAT+ GL
        ...
        hru2%glsubl = hru1%glsubl ! SWAT+ GL
        ...
        hru2%gwe = hru1%gwe / const ! SWAT+GL 
        hru2%pet = hru1%pet
