     ...
     implicit none
      ...
      type soil_physical_properties
        ...
        real :: k = 0.              !! mm/hr        ! vertical saturated hydraulic conductivity of soil layer. Index:(layer,HRU)
        real :: klat = 0.           !! mm/hr        ! lateral saturated hydraulic conductivity of soil layer. Index:(layer,HRU)
      ...
      integer :: flag_klat = 0      !!-               |klat flag (0: klat is k; 1: klat is calibrated standalone and independently from k) 
