...
!!!!!! OLD type 
      ...
      type soilayer_db
        ...
        real :: k = 10.0            !! mm/hr          |vertical saturated hydraulic conductivity of soil layer. Index:(layer,HRU)
        real :: klat = 10.0         !! mm/hr          |lateral saturated hydraulic conductivity of soil layer. Index:(layer,HRU)
