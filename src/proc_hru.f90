      ...
      if (sp_ob%hru > 0) then
        ...
        call sp_read_glcontrol !! SWAT+GL Timo Read Glacier HRU Pars
        call sp_read_glhru !! SWAT+GL Timo Read Glacier HRU Pars
        call sp_read_gles  !! SWAT+GL Timo Read Glacier HRU Pars
