      ...
      !  igl_db = hru(ihru)%dbs%gl
        ...
        hru(ihru)%hyd%surlag = hyd_db(ihyd_db)%surlag ! Timo modification
        hru(ihru)%hyd%plaps = hyd_db(ihyd_db)%plaps ! Timo modification
        hru(ihru)%hyd%tlaps = hyd_db(ihyd_db)%tlaps ! Timo modification
        !! Set hru snow paramters
        isno_db = hru(ihru)%dbs%snow
        hru(ihru)%sno = snodb(isno_db)
        !! SWAT+GL Set HRU Glacier Parameters (Timo Extended)
        !hru(ihru)%gl = gldb(ihru)
        !hru(ihru)%gl%glhruids = gldb(i)%glhruids
      !  hru(ihru)%gl%glmlttmp = gldb(i)%glmlttmp
      !  hru(ihru)%gl%glmfmx =   gldb(i)%glmfmx
      !  hru(ihru)%gl%glmfmn =   gldb(i)%glmfmn
      !  hru(ihru)%gl%f_frz  =   gldb(i)%f_frz 
      !  hru(ihru)%gl%f_accu =   gldb(i)%f_accu
      !  hru(ihru)%gl%tfac   =   gldb(i)%tfac  
      !  hru(ihru)%gl%rfac_s =   gldb(i)%rfac_s
      !  hru(ihru)%gl%rfac_i =   gldb(i)%rfac_i
      !  hru(ihru)%gl%pr_fac =   gldb(i)%pr_fac
      !  hru(ihru)%gl%gl_lag =   gldb(i)%gl_lag
      !!  hru(ihru)%gl%tmix   =   gldb(i)%tmix  
      !  hru(ihru)%gl%f_exp  =   gldb(i)%f_exp 
